...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        {
            _playerScoreText.text = $"Highscore: {PlayerPrefs.GetInt(PREFS_HIGHSCORE)}";
        }
        ...
        public void Submit()
        {
            Leaderboards.DemoSceneLeaderboard.UploadNewEntry(_playerUsernameInput.text, PlayerPrefs.GetInt(PREFS_HIGHSCORE), Callback, ErrorCallback);
        }
